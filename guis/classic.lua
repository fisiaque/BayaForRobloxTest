...
local getcustomassets = {
	['BayaUI/assets/classic/barlogo.png'] = 'rbxasset://barlogo.png',
	['BayaUI/assets/classic/funicon.png'] = 'rbxasset://funicon.png',
	['BayaUI/assets/classic/combaticon.png'] = 'rbxasset://combaticon.png',
	['BayaUI/assets/classic/checkbox.png'] = 'rbxasset://checkbox.png',
	['BayaUI/assets/classic/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['BayaUI/assets/classic/guiicon.png'] = 'rbxasset://guiicon.png',
	['BayaUI/assets/classic/info.png'] = 'rbxasset://info.png',
	['BayaUI/assets/classic/pin.png'] = 'rbxasset://pin.png',
	['BayaUI/assets/classic/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['BayaUI/assets/classic/visualicon.png'] = 'rbxasset://visualicon.png',
	['BayaUI/assets/classic/search.png'] = 'rbxasset://search.png',
	['BayaUI/assets/classic/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['BayaUI/assets/classic/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['BayaUI/assets/classic/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['BayaUI/assets/classic/textbaya.png'] = 'rbxasset://textbaya.png',
	['BayaUI/assets/classic/textv4.png'] = 'rbxasset://textv4.png',
	['BayaUI/assets/classic/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['BayaUI/assets/classic/baya.png'] = 'rbxassetid://71142378499430',
	['BayaUI/assets/classic/inventoryicon.png'] = 'rbxasset://inventoryicon.png'
	['BayaUI/assets/classic/autoicon.png'] = 'rbxasset://autoicon.png'
	['BayaUI/assets/classic/worldicon.png'] = 'rbxasset://worldicon.png'
}
...
do
	local res = isfile('BayaUI/profiles/color.txt') and loadJson('BayaUI/profiles/color.txt')
	if res then
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('BayaUI/assets/classic/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('BayaUI/assets/classic/barlogo.png')
	...
	settingsicon.Image = getcustomasset('BayaUI/assets/classic/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('BayaUI/assets/classic/search.png')
	...
	function categoryapi:CreateBind()
		...
		function optionapi:SetBind(tab, mouse)
			...
			if mainapi.BayaButton then
				mainapi.BayaButton:Destroy()
				mainapi.BayaButton = nil
			end
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('BayaUI/assets/classic/pin.png')
			...
			if categorysettings.Profiles then
				...
				if ind then
					if val ~= 'default' then
						...
						if isfile('BayaUI/profiles/'..val..mainapi.Place..'.txt') and delfile then
							delfile('BayaUI/profiles/'..val..mainapi.Place..'.txt')
						end
					end
				else
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('BayaUI/assets/classic/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('BayaUI/profiles/'..game.GameId..'.gui.txt') then
		guidata = loadJson('BayaUI/profiles/'..game.GameId..'.gui.txt')
		if not guidata then
			guidata = {Categories = {}}
			self:CreateNotification('Baya', 'Failed to load GUI settings.', 10, 'alert')
			savecheck = false
		end
	...
	if isfile('BayaUI/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('BayaUI/profiles/'..self.Profile..self.Place..'.txt')
		if not savedata then
			...
			self:CreateNotification('Baya', 'Failed to load '..self.Profile..' profile.', 10, 'alert')
			savecheck = false
		end
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('BayaUI/assets/classic/baya.png')
		image.Parent = button
...
function mainapi:Save(newprofile)
	...
	writefile('BayaUI/profiles/'..game.GameId..'.gui.txt', httpService:JSONEncode(guidata))
	writefile('BayaUI/profiles/'..self.Profile..self.Place..'.txt', httpService:JSONEncode(savedata))
end
...
function mainapi:Uninject()
	...
	loopClean(mainapi)
	shared.baya = nil
	shared.bayareload = nil
	shared.BayaIndependent = nil
end
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('BayaUI/assets/classic/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('BayaUI/assets/classic/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Fun',
	Icon = getcustomasset('BayaUI/assets/classic/funicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Visual',
	Icon = getcustomasset('BayaUI/assets/classic/visualicon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('BayaUI/assets/classic/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('BayaUI/assets/classic/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('BayaUI/assets/classic/inventoryicon.png')
})
mainapi:CreateCategory({
	Name = 'Auto',
	Icon = getcustomasset('BayaUI/assets/classic/autoicon.png')
})
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('BayaUI/assets/classic/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('BayaUI/assets/classic/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('BayaUI/assets/classic/profilesicon.png'),
...
topbar:CreateDropdown({
	Name = 'GUI Theme',
	List = inputService.TouchEnabled and {'new', 'classic'} or {'new', 'classic', 'rise'},
	Function = function(val, mouse)
		if mouse then
			...
			if shared.BayaDeveloper then
				...
				loadstring(game:HttpGet('https://raw.githubusercontent.com/fisiaque/BayaForRobloxTest/'..readfile('BayaUI/profiles/commit.txt')..'/loader.lua', true))()
			end
		end
	end,
...
topbar:CreateButton({
	...
	mainapi.Save = function() end
		if isfile('BayaUI/profiles/'..mainapi.Profile..mainapi.Place..'.txt') and delfile then
			delfile('BayaUI/profiles/'..mainapi.Profile..mainapi.Place..'.txt')
		end
		shared.bayareload = true
		if shared.BayaDeveloper then
			loadstring(readfile('BayaUI/loader.lua'), 'loader')()
	...
	Tooltip = 'This will set your profile to the default settings of Baya'
})
topbar:CreateButton({
...
topbar:CreateButton({
	...
	Tooltip = 'Removes baya from the current game'
})
topbar:CreateButton({
	Name = 'REINEJCT',
	Function = function()
	...
	Tooltip = 'Reloads baya for debugging purposes'
})
topbar:CreateBind()
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('BayaUI/assets/classic/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
local BayaTextScale = Instance.new('UIScale')
BayaTextScale.Parent = textgui.Children
...
local textguiwatermark = textgui:CreateToggle({
	Name = 'Watermark',
	Tooltip = 'Renders a baya watermark',
	Function = function()
		mainapi:UpdateTextGUI()
	end
})
...
local BayaLabels = {}
local BayaLogo = Instance.new('ImageLabel')
BayaLogo.Name = 'Logo'
BayaLogo.Size = UDim2.fromOffset(96, 26)
BayaLogo.Position = UDim2.new(1, -142, 0, 3)
BayaLogo.BackgroundTransparency = 1
BayaLogo.BorderSizePixel = 0
BayaLogo.Visible = true
BayaLogo.BackgroundColor3 = Color3.new()
BayaLogo.Image = getcustomasset('BayaUI/assets/classic/textbaya.png')
...
local BayaLogoV4 = Instance.new('ImageLabel')
BayaLogoV4.Name = 'Logo2'
BayaLogoV4.Size = UDim2.fromOffset(43, 30)
BayaLogoV4.Position = UDim2.new(1, 1, 0, -2)
BayaLogoV4.BackgroundColor3 = Color3.new()
BayaLogoV4.BackgroundTransparency = 1
BayaLogoV4.BorderSizePixel = 0
BayaLogoV4.Image = getcustomasset('BayaUI/assets/classic/textv4.png')
BayaLogoV4.Parent = BayaLogo
local BayaLogoShadow = BayaLogo:Clone()
BayaLogoShadow.Position = UDim2.fromOffset(1, 1)
BayaLogoShadow.ZIndex = 0
BayaLogoShadow.Visible = true
BayaLogoShadow.ImageColor3 = Color3.new()
BayaLogoShadow.ImageTransparency = 0.65
BayaLogoShadow.Parent = BayaLogo
BayaLogoShadow.Logo2.ZIndex = 0
BayaLogoShadow.Logo2.ImageColor3 = Color3.new()
BayaLogoShadow.Logo2.ImageTransparency = 0.65
local BayaLogoGradient = Instance.new('UIGradient')
BayaLogoGradient.Rotation = 90
BayaLogoGradient.Parent = BayaLogo
local BayaLogoGradient2 = Instance.new('UIGradient')
BayaLogoGradient2.Rotation = 90
BayaLogoGradient2.Parent = BayaLogoV4
local BayaLabelHolder = Instance.new('Frame')
BayaLabelHolder.Name = 'Holder'
BayaLabelHolder.Size = UDim2.fromScale(1, 1)
BayaLabelHolder.Position = UDim2.fromOffset(5, 37)
BayaLabelHolder.BackgroundTransparency = 1
BayaLabelHolder.Parent = textgui.Children
local BayaLabelSorter = Instance.new('UIListLayout')
BayaLabelSorter.HorizontalAlignment = Enum.HorizontalAlignment.Right
BayaLabelSorter.VerticalAlignment = Enum.VerticalAlignment.Top
BayaLabelSorter.SortOrder = Enum.SortOrder.LayoutOrder
BayaLabelSorter.Parent = BayaLabelHolder
...
function mainapi:UpdateTextGUI(afterload)
	...
	if textgui.Button.Enabled then
		...
		BayaLogo.Visible = textguiwatermark.Enabled
		BayaLogo.Position = right and UDim2.new(1 / BayaTextScale.Scale, -141, 0, 4) or UDim2.fromOffset(5, 4)
		BayaLogoShadow.Visible = textguishadow.Enabled
		BayaLabelSorter.HorizontalAlignment = right and Enum.HorizontalAlignment.Right or Enum.HorizontalAlignment.Left
		BayaLabelHolder.Size = UDim2.fromScale(1 / BayaTextScale.Scale, 1)
		BayaLabelHolder.Position = UDim2.fromOffset(4, 4 + (BayaLogo.Visible and BayaLogo.Size.Y.Offset or 0))

		local found = {}
		for _, v in BayaLabels do
			if v.Enabled then
				table.insert(found, v.Object.Name)
			end
			v.Object:Destroy()
		end
		table.clear(BayaLabels)
		...
		if textguisort.Value == 'Alphabetical' then
			table.sort(BayaLabels, function(a, b)
...
function mainapi:UpdateGUI(hue, sat, val, default)
	...
	if textgui.Button.Enabled then
		BayaLogoGradient.Color = ColorSequence.new({
		...
		BayaLogoGradient2.Color = mainapi.GUIColor.Rainbow and BayaLogoGradient.Color or ColorSequence.new({
			ColorSequenceKeypoint.new(0, Color3.new(1, 1, 1)),
			ColorSequenceKeypoint.new(1, Color3.new(1, 1, 1))
		})
		for i, v in BayaLabels do
			v.Text.TextColor3 = customcolor or (mainapi.GUIColor.Rainbow and Color3.fromHSV(mainapi:Color((hue - ((i + 2) * 0.025)) % 1)) or BayaLogoGradient.Color.Keypoints[2].Value)
		end
	end
