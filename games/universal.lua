...
run(function()
	...
	ParticleTexture = Killaura:CreateTextBox({
		Name = 'Texture',
		Default = 'rbxassetid://102202488860322',
		Function = function()
			for _, v in Particles do
		...
		Function = function(callback)
			if callback then
				...
				if Texture.Value:find('.webm') then
					...
					decal.Image = Texture.Value ~= '' and (Texture.Value:find('rbxasset') and Texture.Value or assetfunction(Texture.Value)) or 'rbxassetid://140099042178654'
					decal.Size = UDim2.fromScale(1, 1)
					decal.BackgroundTransparency = 1
					decal.Parent = capesurface
				end
